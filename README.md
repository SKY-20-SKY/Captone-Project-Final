...
Our Exploratory Data Analysis (EDA) revealed several critical factors that correlate strongly with customer loss:
...
We evaluated several tuned models, including Logistic Regression, KNN, Decision Trees, and SVM. 

### **The Tuned Logistic Regression Model**
This was selected as the most practical choice for production. It achieved a test accuracy of **0.82** with a balanced **Precision (0.70)** and **F1-score (0.63)**. While the SVM model showed similar performance, Logistic Regression offers superior interpretability and significantly faster training times, which is vital for frequent model updates.
...
3. **Value-Add Service Promotion:** Educate customers on the advantages of "Online Security" and "Tech Support" during onboarding to increase customer "stickiness."
